<!DOCTYPE html>
<html>
<head><meta name='robots' content='none' /><base href="https://n83.network-auth.com/DFINITY/hi/ocP50btb/" />
  <title> DFINITY</title>
...
<body>
  <div id="content">
    <div id="container">
      ...
      <div id="continue">
        <h1>Welcome to DFINITY</h1>
        <p></p>
        <a class="button" href="https://n83.network-auth.com/DFINITY/hi/ocP50btb/grant?continue_url=http://google.com/" onclick = "javascript:(function() {
          var _request = new XMLHttpRequest();
          var url = 'https://n83.network-auth.com/DFINITY/hi/ocP50btb/grant?continue_url=CONTINUE_URL_PLACEHOLDER';
    ...
    <div class="footer">
      <h3>POWERED BY</h3>
      <img alt="Cisco Meraki" src="/images/cisco-meraki-gray.png?1544821141" width="100" />
    </div>
  </div>
      ...
      <script type="text/javascript" charset="utf-8">
        ...
        var _request = new XMLHttpRequest();
        var url = 'https://n83.network-auth.com/DFINITY/hi/ocP50btb/login?continue_url=CONTINUE_URL_PLACEHOLDER';
        _request.open('HEAD', window.location, true);
        _request.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
        _request.onreadystatechange = function() {
          if (_request.readyState === 4) {
